...
export default function Login() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Supabase will redirect to the callback page
    } catch (err: unknown) {
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-4 w-full py-3 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium rounded-xl transition-colors flex items-center justify-center gap-2"
            >
